...
RL_DEFAULT_SHADER_ATTRIB_LOCATION_BONEINDICES: int = 7
RL_DEFAULT_SHADER_ATTRIB_LOCATION_BONEWEIGHTS: int = 8
RL_DEFAULT_SHADER_ATTRIB_LOCATION_INSTANCETRANSFORM: int = 9
...
RL_DEFAULT_SHADER_ATTRIB_NAME_BONEINDICES: str = "vertexBoneIndices"
RL_DEFAULT_SHADER_ATTRIB_NAME_BONEWEIGHTS: str = "vertexBoneWeights"
RL_DEFAULT_SHADER_ATTRIB_NAME_INSTANCETRANSFORM: str = "instanceTransform"
...
RL_DEFAULT_SHADER_UNIFORM_NAME_BONEMATRICES: str = "boneMatrices"
RAYGUI_VERSION_MAJOR: int = 5
RAYGUI_VERSION_MINOR: int = 0
RAYGUI_VERSION_PATCH: int = 0
RAYGUI_VERSION: str = "5.0-dev"
...
RAYGUI_WINDOWBOX_CLOSEBUTTON_HEIGHT: int = 18
...
RAYGUI_TABBAR_ITEM_WIDTH: int = 148
...
RAYGUI_TEXTBOX_AUTO_CURSOR_COOLDOWN: int = 20
